...
// 静态内部类
public class SingletonStaticInnerStrategy {
    private static class SingletonHolder {
        private static final SingletonStaticInnerStrategy instance = new SingletonStaticInnerStrategy();
    }

    private SingletonStaticInnerStrategy() {
    }

    public static final SingletonStaticInnerStrategy getInstance() {
