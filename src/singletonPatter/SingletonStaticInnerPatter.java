...
// 静态内部类
public class SingletonStaticInnerPatter {
    private static class SingletonHolder {
        private static final SingletonStaticInnerPatter instance = new SingletonStaticInnerPatter();
    }

    private SingletonStaticInnerPatter() {
    }

    public static final SingletonStaticInnerPatter getInstance() {
